...
import { NavbarContainer, NavContent, NavSection } from './Navbar.style';
import {FavoriteButton} from '../FavoriteButton/FavoriteButton';
import {Logo, Favorite} from './Navbar.style';
import { useHistory } from 'react-router-dom';

export const Navbar = () => {
  const history = useHistory();
  const showFavorite = () => {
    history.push(`/favorite-albums`);
  }
  return (
    <NavbarContainer>
      <NavSection>
        <NavContent>
          ...
          <Favorite onClick={showFavorite}><FavoriteButton/></Favorite>
        </NavContent>
      </NavSection>
    </NavbarContainer>
  );
